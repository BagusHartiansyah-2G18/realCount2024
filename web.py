...
with container1:
    st.header('1. Daftar Suara Tertinggi Perwakilan Partai :sparkles:')
...
with st.container():
    ...
    st.header('2. Daftar Caleg Berdasarkan Partai')   
...
with st.container():
    st.markdown("<div class='container1'></div>", unsafe_allow_html=True)
    st.header('3. Daftar Suara dari Desa / Kelurahan Berdasarkan Nama Caleg')   
...
with st.container():
    st.markdown("<div class='container1'></div>", unsafe_allow_html=True)
    st.header('4. total suara tiap TPS dari setiap Desa / Kelurahan Berdasarkan Nama Caleg')   
